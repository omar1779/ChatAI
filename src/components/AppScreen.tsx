  ...
  return (
    <div className={clsx('flex flex-col', className)} {...props}>
      <div className="flex justify-between px-4 pt-4">
        ...
        <Logo color={'text-green-600'} h={'20'} w={'20'} textSize={'text-lg'} />
...
>(function AppScreenHeader({ children }, ref) {
  return (
    <div ref={ref} className="mt-6 px-4 text-green-600">
      {children}
    </div>
  )
})
...
>(function AppScreenTitle({ children }, ref) {
  return (
    <div ref={ref} className="text-2xl text-green-600">
      {children}
    </div>
  )
})
...
>(function AppScreenBody({ children, className }, ref) {
  return (
    <div
      ref={ref}
      className={clsx('white mt-6 flex-auto rounded-t-2xl', className)}
    >
      {children}
    </div>
  )
